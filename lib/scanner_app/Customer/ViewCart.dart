...
class _ViewcartState extends State<Viewcart> {
                                                                      ...
                                                                      onPressed: () {
                                                                        setState(() {
                                                                          delrecord(snapshot
                                                                              ...
                                                                              snapshot.data[index].product_qty);
                                                                        });
                                                                        Navigator.pushReplacement(
                                                                            context,
                                                                            MaterialPageRoute(
                                                                                builder: (context) =>
                                                                                    Customer_Dashboard(uiddata: uid_key)));
                                                                      },
  ...
  Future<void> delrecord(String id,String productid,product_qty) async {
    print("testing productqty $product_qty");
